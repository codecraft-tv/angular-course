...
TIP: Don't name your component `HeaderComponent`. Angular CLI automatically appends `Component` to the name, so your component class would end up being `HeaderComponentComponent`.
