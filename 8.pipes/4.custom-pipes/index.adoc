...
Usually, to guide the tooling and compiler , we should add an interface called PipeTransform to the class. Just like life cycle hooks, this interface is also optional, but it is a good practice.
